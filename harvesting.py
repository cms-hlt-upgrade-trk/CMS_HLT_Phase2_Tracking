...
# with command line options: step4 -s HARVESTING:@standardValidation+@standardDQM+@ExtraHLT+@miniAODValidation+@miniAODDQM+@nanoAODDQM --conditions auto:phase1_2022_realistic --mc --geometry DB:Extended --scenario pp --filetype DQM --era Run3 -n 100 --filein file:A6E888C6-3A70-4348-86BB-F21DF4E9E891.root
...
process.source = cms.Source("DQMRootSource",
    fileNames = cms.untracked.vstring('file:Phase2HLT_DQM.root')
)
